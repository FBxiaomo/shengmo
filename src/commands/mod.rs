...
pub(crate) use crate::types::{
    ...
    StyleSystemPrompts, UserPreferences, VocabPresetStore,
};
...
mod tests {
    ...
    use crate::commands::settings::{
        persist_settings, SettingsWriter,
    };
    ...
    struct FakeSettingsWriter {
        ...
        toggle_mini_refreshes: Mutex<u32>,
    ...
    impl SettingsWriter for FakeSettingsWriter {
        ...
        fn refresh_toggle_mini_hotkey(&self) {
            *self.toggle_mini_refreshes.lock().unwrap() += 1;
        }
