...
mod tests {
    ...
    async fn mimo_posts_chat_completion_audio_request() {
        ...
        asr.consume_pcm_chunk(&crate::asr::pcm::make_pcm_with_rms(32_000, 0.05));
    ...
    async fn mimo_splits_audio_before_base64_limit() {
        ...
        let pcm = crate::asr::pcm::make_pcm_with_rms(32_000 * 181, 0.05);
