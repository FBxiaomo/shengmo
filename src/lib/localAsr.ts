...
const MOCK_SETTINGS: LocalAsrSettings = {
    ...
    mirror: "huggingface",
    modelsBaseDir: null,
    modelsRootDir: "~/Library/Application Support/声墨/models",
...
export interface SherpaOnnxCatalogModel {
    alias: SherpaOnnxModelAlias | string
    displayName: string
    family: "senseVoice" | "paraformer" | "whisper" | "qwen3Asr" | "zipformer"
    mode: "offline" | "online"
    languages: string[]
    qualityTier: string
    cached: boolean
...
export const SHERPA_ONNX_ASR_MODELS: SherpaOnnxModelOption[] = [
    ...
    },
    {
        ...
        labelKey: "localAsr.sherpaModelParaformerStreaming",
        descKey: "localAsr.sherpaModelParaformerStreamingDesc",
    },
    {
    ...
    },
    {
        ...
        labelKey: "localAsr.sherpaModelZipformerSmallCtc",
        descKey: "localAsr.sherpaModelZipformerSmallCtcDesc",
    },
]
...
export function getSherpaOnnxAsrCatalog(): Promise<SherpaOnnxCatalogModel[]> {
    return invokeOrMock("sherpa_onnx_asr_catalog", undefined, () => [
        ...
        {
            alias: "paraformer-streaming-zh" as const,
            displayName: "Paraformer Streaming",
            family: "paraformer",
            mode: "online",
            languages: ["zh"],
            qualityTier: "streaming-chinese",
            cached: false,
            downloadedBytes: 0,
            fileSizeMb: 220,
        },
        ...
        },
        {
            ...
            mode: "online",
            languages: ["zh", "en"],
            qualityTier: "streaming-experimental",
            cached: false,
            downloadedBytes: 0,
            fileSizeMb: 90,
        },
        {
            alias: "zipformer-small-ctc-zh-streaming" as const,
            displayName: "Zipformer CTC Streaming",
            family: "zipformer",
            mode: "online",
            languages: ["zh"],
            qualityTier: "streaming-ctc",
            cached: false,
            downloadedBytes: 0,
            fileSizeMb: 80,
        },
