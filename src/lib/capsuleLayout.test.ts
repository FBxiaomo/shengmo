...
assertEqual(winMetrics.height, 47, 'windows capsule increases pill height');
...
assertEqual(winHost.height, 79, 'windows capsule host keeps regular height');
...
assertEqual(winHostWithTranslation.height, 113, 'windows translation capsule grows vertically only');
