...
export function defaultOpenAppShortcut(): ShortcutBinding {
  return { primary: 'M', modifiers: defaultAppShortcutModifiers() };
}

export function defaultToggleMiniShortcut(): ShortcutBinding {
  return { primary: 'L', modifiers: defaultAppShortcutModifiers() };
}
