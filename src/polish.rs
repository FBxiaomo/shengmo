...
impl CodexOAuthLLMProvider {
        ...
        C: Fn() -> bool + Send + Sync,
    {
        ...
        let mut body = json!({
            ...
            "instructions": "You are ShengMo's text polishing assistant. Follow the developer messages exactly and return only the final user-visible text.",
        });
